...
select game_id, home_team_id,    CASE WHEN bx.winner_home_or_away = 'H' THEN 1 ELSE 0 END AS HomeTeamWins,
,h_ttol_bases,_roll_strikeout, a_roll_strikeout, h_roll_hit, a_roll_hit,home_runs, away-runns, home_hits, away_hit  from
boxscore bx
